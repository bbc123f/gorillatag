	...
	private void UpdateDoorState()
	{
		...
		case GTDoor.DoorState.Closed:
			if (this.buttonTriggeredThisFrame)
			{
				...
				{
					base.photonView.RPC("ChangeDoorState", RpcTarget.AllViaServer, new object[] { GTDoor.DoorState.Opening });
		...
		case GTDoor.DoorState.Closing:
			...
			if (this.peopleInHoldOpenVolume)
			{
				...
				{
					base.photonView.RPC("ChangeDoorState", RpcTarget.AllViaServer, new object[] { GTDoor.DoorState.HeldOpen });
				}
		...
		case GTDoor.DoorState.Open:
			if (Time.time - this.tLastOpened > this.timeUntilDoorCloses)
			{
				...
				{
					base.photonView.RPC("ChangeDoorState", RpcTarget.AllViaServer, new object[] { GTDoor.DoorState.Closing });
