...
public class NonCosmeticItemProvider : MonoBehaviour
{
	private void OnTriggerEnter(Collider other)
	{
		...
		if (component != null)
		{
			...
			GorillaGameManager.instance.FindVRRigForPlayer(PhotonNetwork.LocalPlayer).RPC("EnableNonCosmeticHandItemRPC", RpcTarget.All, new object[] { true, component.isLeftHand });
		}
	}
