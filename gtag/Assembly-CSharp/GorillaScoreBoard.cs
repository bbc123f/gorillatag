...
public class GorillaScoreBoard : MonoBehaviour
{
	...
	{
		this.initialGameMode = PhotonNetworkController.Instance.initialGameMode;
		if (this.initialGameMode.Contains("CASUAL"))
		{
			return "CASUAL";
		}
		if (this.initialGameMode.Contains("INFECTION"))
		{
			return "INFECTION";
		}
		if (this.initialGameMode.Contains("HUNT"))
		{
			return "HUNT";
		}
		if (this.initialGameMode.Contains("BATTLE"))
		{
			return "BATTLE";
		}
		return "ERROR";
