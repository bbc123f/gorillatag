	...
	public event SizeChangerTrigger.SizeChangerTriggerEvent OnEnter
	{
		...
		add
		{
			...
			do
			{
				...
				SizeChangerTrigger.SizeChangerTriggerEvent value2 = (SizeChangerTrigger.SizeChangerTriggerEvent)Delegate.Combine(sizeChangerTriggerEvent2, value);
				sizeChangerTriggerEvent = Interlocked.CompareExchange<SizeChangerTrigger.SizeChangerTriggerEvent>(ref this.OnEnter, value2, sizeChangerTriggerEvent2);
			}
		...
		remove
		{
			...
			{
				sizeChangerTriggerEvent2 = sizeChangerTriggerEvent;
				SizeChangerTrigger.SizeChangerTriggerEvent value2 = (SizeChangerTrigger.SizeChangerTriggerEvent)Delegate.Remove(sizeChangerTriggerEvent2, value);
				sizeChangerTriggerEvent = Interlocked.CompareExchange<SizeChangerTrigger.SizeChangerTriggerEvent>(ref this.OnEnter, value2, sizeChangerTriggerEvent2);
			}
			while (sizeChangerTriggerEvent != sizeChangerTriggerEvent2);
		}
	...
	public event SizeChangerTrigger.SizeChangerTriggerEvent OnExit
	{
		...
		add
		{
			...
			do
			{
				sizeChangerTriggerEvent2 = sizeChangerTriggerEvent;
				SizeChangerTrigger.SizeChangerTriggerEvent value2 = (SizeChangerTrigger.SizeChangerTriggerEvent)Delegate.Combine(sizeChangerTriggerEvent2, value);
				sizeChangerTriggerEvent = Interlocked.CompareExchange<SizeChangerTrigger.SizeChangerTriggerEvent>(ref this.OnExit, value2, sizeChangerTriggerEvent2);
			}
			while (sizeChangerTriggerEvent != sizeChangerTriggerEvent2);
		}
		[CompilerGenerated]
