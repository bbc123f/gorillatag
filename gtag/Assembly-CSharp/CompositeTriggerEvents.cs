	...
	public event CompositeTriggerEvents.TriggerEvent CompositeTriggerEnter
	{
		...
		add
		{
			...
			do
			{
				...
				CompositeTriggerEvents.TriggerEvent value2 = (CompositeTriggerEvents.TriggerEvent)Delegate.Combine(triggerEvent2, value);
				triggerEvent = Interlocked.CompareExchange<CompositeTriggerEvents.TriggerEvent>(ref this.CompositeTriggerEnter, value2, triggerEvent2);
			}
		...
		remove
		{
			...
			{
				triggerEvent2 = triggerEvent;
				CompositeTriggerEvents.TriggerEvent value2 = (CompositeTriggerEvents.TriggerEvent)Delegate.Remove(triggerEvent2, value);
				triggerEvent = Interlocked.CompareExchange<CompositeTriggerEvents.TriggerEvent>(ref this.CompositeTriggerEnter, value2, triggerEvent2);
			}
			while (triggerEvent != triggerEvent2);
		}
	...
	public event CompositeTriggerEvents.TriggerEvent CompositeTriggerExit
	{
		...
		add
		{
			...
			do
			{
				triggerEvent2 = triggerEvent;
				CompositeTriggerEvents.TriggerEvent value2 = (CompositeTriggerEvents.TriggerEvent)Delegate.Combine(triggerEvent2, value);
				triggerEvent = Interlocked.CompareExchange<CompositeTriggerEvents.TriggerEvent>(ref this.CompositeTriggerExit, value2, triggerEvent2);
			}
			while (triggerEvent != triggerEvent2);
		}
		[CompilerGenerated]
