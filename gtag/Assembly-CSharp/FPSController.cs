	...
	public event FPSController.OnStateChangeEventHandler OnStartEvent
	{
		...
		add
		{
			...
			do
			{
				...
				FPSController.OnStateChangeEventHandler value2 = (FPSController.OnStateChangeEventHandler)Delegate.Combine(onStateChangeEventHandler2, value);
				onStateChangeEventHandler = Interlocked.CompareExchange<FPSController.OnStateChangeEventHandler>(ref this.OnStartEvent, value2, onStateChangeEventHandler2);
			}
		...
		remove
		{
			...
			{
				onStateChangeEventHandler2 = onStateChangeEventHandler;
				FPSController.OnStateChangeEventHandler value2 = (FPSController.OnStateChangeEventHandler)Delegate.Remove(onStateChangeEventHandler2, value);
				onStateChangeEventHandler = Interlocked.CompareExchange<FPSController.OnStateChangeEventHandler>(ref this.OnStartEvent, value2, onStateChangeEventHandler2);
			}
			while (onStateChangeEventHandler != onStateChangeEventHandler2);
		}
	...
	public event FPSController.OnStateChangeEventHandler OnStopEvent
	{
		...
		add
		{
			...
			do
			{
				onStateChangeEventHandler2 = onStateChangeEventHandler;
				FPSController.OnStateChangeEventHandler value2 = (FPSController.OnStateChangeEventHandler)Delegate.Combine(onStateChangeEventHandler2, value);
				onStateChangeEventHandler = Interlocked.CompareExchange<FPSController.OnStateChangeEventHandler>(ref this.OnStopEvent, value2, onStateChangeEventHandler2);
			}
			while (onStateChangeEventHandler != onStateChangeEventHandler2);
		}
		[CompilerGenerated]
