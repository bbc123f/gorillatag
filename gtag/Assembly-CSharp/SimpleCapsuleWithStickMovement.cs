	...
	public event Action CameraUpdated
	{
		...
		add
		{
			...
			do
			{
				...
				action = Interlocked.CompareExchange<Action>(ref this.CameraUpdated, value2, action2);
			}
	...
	public event Action PreCharacterMove
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.PreCharacterMove, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
