	...
	public class TrainCrossingController : MonoBehaviour
	{
		...
		private sealed class <AnimateCrossing>d__15 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			bool IEnumerator.MoveNext()
			{
				...
				float t = (Time.time - lightBlinkStartTime) / lightBlinkDuration;
				lightToBlinkOn.SetColor(trainCrossingController._colorId, Color.Lerp(offColor, onColor, t));
				lightToBlinkOff.SetColor(trainCrossingController._colorId, Color.Lerp(onColor, offColor, t));
				if (Time.time > lightBlinkEndTime)
				{
					Material material = lightToBlinkOn;
					lightToBlinkOn = lightToBlinkOff;
