...
public class RequestableOwnershipGuard : MonoBehaviourPunCallbacks, ISelfValidator
{
	...
	private sealed class <RequestTimeout>d__42 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		bool IEnumerator.MoveNext()
		{
			...
			case NetworkingState.RequestingOwnershipWaitingForSight:
			case NetworkingState.ForcefullyTakingOverWaitingForSight:
				requestableOwnershipGuard.photonView.RPC("OwnershipRequested", requestableOwnershipGuard.actualOwner, new object[]
				{
					requestableOwnershipGuard.ownershipRequestNonce
				});
				break;
			default:
				throw new ArgumentOutOfRangeException();
