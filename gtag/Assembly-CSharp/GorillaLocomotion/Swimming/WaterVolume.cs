	...
	public class WaterVolume : BaseGuidedRefTargetMono
	{
		public event WaterVolume.WaterVolumeEvent ColliderEnteredVolume
		{
			...
			add
			{
				...
				do
				{
					...
					WaterVolume.WaterVolumeEvent value2 = (WaterVolume.WaterVolumeEvent)Delegate.Combine(waterVolumeEvent2, value);
					waterVolumeEvent = Interlocked.CompareExchange<WaterVolume.WaterVolumeEvent>(ref this.ColliderEnteredVolume, value2, waterVolumeEvent2);
				}
			...
			remove
			{
				...
				{
					waterVolumeEvent2 = waterVolumeEvent;
					WaterVolume.WaterVolumeEvent value2 = (WaterVolume.WaterVolumeEvent)Delegate.Remove(waterVolumeEvent2, value);
					waterVolumeEvent = Interlocked.CompareExchange<WaterVolume.WaterVolumeEvent>(ref this.ColliderEnteredVolume, value2, waterVolumeEvent2);
				}
				while (waterVolumeEvent != waterVolumeEvent2);
			}
		...
		public event WaterVolume.WaterVolumeEvent ColliderExitedVolume
		{
			...
			add
			{
				...
				do
				{
					waterVolumeEvent2 = waterVolumeEvent;
					WaterVolume.WaterVolumeEvent value2 = (WaterVolume.WaterVolumeEvent)Delegate.Combine(waterVolumeEvent2, value);
					waterVolumeEvent = Interlocked.CompareExchange<WaterVolume.WaterVolumeEvent>(ref this.ColliderExitedVolume, value2, waterVolumeEvent2);
				}
				while (waterVolumeEvent != waterVolumeEvent2);
			}
			[CompilerGenerated]
		...
		public event WaterVolume.WaterVolumeEvent ColliderEnteredWater
		{
			...
			add
			{
				...
				do
				{
					waterVolumeEvent2 = waterVolumeEvent;
					WaterVolume.WaterVolumeEvent value2 = (WaterVolume.WaterVolumeEvent)Delegate.Combine(waterVolumeEvent2, value);
					waterVolumeEvent = Interlocked.CompareExchange<WaterVolume.WaterVolumeEvent>(ref this.ColliderEnteredWater, value2, waterVolumeEvent2);
				}
				while (waterVolumeEvent != waterVolumeEvent2);
			}
			[CompilerGenerated]
		...
		public event WaterVolume.WaterVolumeEvent ColliderExitedWater
		{
			...
			add
			{
				...
				do
				{
					waterVolumeEvent2 = waterVolumeEvent;
					WaterVolume.WaterVolumeEvent value2 = (WaterVolume.WaterVolumeEvent)Delegate.Combine(waterVolumeEvent2, value);
					waterVolumeEvent = Interlocked.CompareExchange<WaterVolume.WaterVolumeEvent>(ref this.ColliderExitedWater, value2, waterVolumeEvent2);
				}
				while (waterVolumeEvent != waterVolumeEvent2);
			}
			[CompilerGenerated]
		...
		private void OnTriggerEnter(Collider other)
		{
			...
			if (component2 != null)
			{
				...
				waterOverlappingCollider.scaleMultiplier = (component2.scaleByPlayersScale ? Player.Instance.scale : 1f);
			}
			else
			{
