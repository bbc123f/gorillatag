			...
			bool IEnumerator.MoveNext()
			{
				...
				try
				{
					...
					else
					{
						...
						error = null;
						NetworkSceneManagerBase.FinishedLoadingDelegate finished = new NetworkSceneManagerBase.FinishedLoadingDelegate(CS$<>8__locals1.<SwitchSceneWrapper>b__0);
						this.<>1__state = -3;
						...
						coro = networkSceneManagerBase.SwitchScene(prevScene, newScene, finished);
						next = true;
					}
					while (next)
					{
