...
public static class GTDev
{
	...
	public static event Action<GTDev.LogEntry> OnLogEntry
	{
		...
		add
		{
			...
			{
				action2 = action;
				Action<GTDev.LogEntry> value2 = (Action<GTDev.LogEntry>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action<GTDev.LogEntry>>(ref GTDev.OnLogEntry, value2, action2);
			}
		...
		remove
		{
			...
			{
				action2 = action;
				Action<GTDev.LogEntry> value2 = (Action<GTDev.LogEntry>)Delegate.Remove(action2, value);
				action = Interlocked.CompareExchange<Action<GTDev.LogEntry>>(ref GTDev.OnLogEntry, value2, action2);
			}
			while (action != action2);
		}
