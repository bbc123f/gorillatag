	...
	public static event LightningDispatcher.DispatchLightningEvent RequestLightningStrike
	{
		...
		add
		{
			...
			do
			{
				...
				LightningDispatcher.DispatchLightningEvent value2 = (LightningDispatcher.DispatchLightningEvent)Delegate.Combine(dispatchLightningEvent2, value);
				dispatchLightningEvent = Interlocked.CompareExchange<LightningDispatcher.DispatchLightningEvent>(ref LightningDispatcher.RequestLightningStrike, value2, dispatchLightningEvent2);
			}
		...
		remove
		{
			...
			{
				dispatchLightningEvent2 = dispatchLightningEvent;
				LightningDispatcher.DispatchLightningEvent value2 = (LightningDispatcher.DispatchLightningEvent)Delegate.Remove(dispatchLightningEvent2, value);
				dispatchLightningEvent = Interlocked.CompareExchange<LightningDispatcher.DispatchLightningEvent>(ref LightningDispatcher.RequestLightningStrike, value2, dispatchLightningEvent2);
			}
			while (dispatchLightningEvent != dispatchLightningEvent2);
		}
