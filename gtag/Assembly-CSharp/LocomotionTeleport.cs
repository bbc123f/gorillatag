...
public class LocomotionTeleport : MonoBehaviour
{
	...
	public event Action<bool, Vector3?, Quaternion?, Quaternion?> UpdateTeleportDestination
	{
		...
		add
		{
			...
			{
				action2 = action;
				Action<bool, Vector3?, Quaternion?, Quaternion?> value2 = (Action<bool, Vector3?, Quaternion?, Quaternion?>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action<bool, Vector3?, Quaternion?, Quaternion?>>(ref this.UpdateTeleportDestination, value2, action2);
			}
		...
		remove
		{
			...
			{
				action2 = action;
				Action<bool, Vector3?, Quaternion?, Quaternion?> value2 = (Action<bool, Vector3?, Quaternion?, Quaternion?>)Delegate.Remove(action2, value);
				action = Interlocked.CompareExchange<Action<bool, Vector3?, Quaternion?, Quaternion?>>(ref this.UpdateTeleportDestination, value2, action2);
			}
			while (action != action2);
		}
	...
	public event Action EnterStateReady
	{
		...
		add
		{
			...
			do
			{
				...
				action = Interlocked.CompareExchange<Action>(ref this.EnterStateReady, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStateAim
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStateAim, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action<LocomotionTeleport.AimData> UpdateAimData
	{
		...
		add
		{
			...
			{
				action2 = action;
				Action<LocomotionTeleport.AimData> value2 = (Action<LocomotionTeleport.AimData>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action<LocomotionTeleport.AimData>>(ref this.UpdateAimData, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
		remove
		{
			...
			{
				action2 = action;
				Action<LocomotionTeleport.AimData> value2 = (Action<LocomotionTeleport.AimData>)Delegate.Remove(action2, value);
				action = Interlocked.CompareExchange<Action<LocomotionTeleport.AimData>>(ref this.UpdateAimData, value2, action2);
			}
			while (action != action2);
		}
	...
	public event Action ExitStateAim
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.ExitStateAim, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStateCancelAim
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStateCancelAim, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStatePreTeleport
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStatePreTeleport, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStateCancelTeleport
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStateCancelTeleport, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStateTeleporting
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStateTeleporting, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action EnterStatePostTeleport
	{
		...
		add
		{
			...
			do
			{
				action2 = action;
				Action value2 = (Action)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action>(ref this.EnterStatePostTeleport, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
	...
	public event Action<Transform, Vector3, Quaternion> Teleported
	{
		...
		add
		{
			...
			{
				action2 = action;
				Action<Transform, Vector3, Quaternion> value2 = (Action<Transform, Vector3, Quaternion>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange<Action<Transform, Vector3, Quaternion>>(ref this.Teleported, value2, action2);
			}
			while (action != action2);
		}
		[CompilerGenerated]
		remove
		{
			...
			{
				action2 = action;
				Action<Transform, Vector3, Quaternion> value2 = (Action<Transform, Vector3, Quaternion>)Delegate.Remove(action2, value);
				action = Interlocked.CompareExchange<Action<Transform, Vector3, Quaternion>>(ref this.Teleported, value2, action2);
			}
			while (action != action2);
		}
