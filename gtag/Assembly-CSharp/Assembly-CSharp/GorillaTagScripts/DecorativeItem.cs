...
namespace GorillaTagScripts
{
	public class DecorativeItem : TransferrableObject
	{
		...
		protected override void LateUpdateLocal()
		{
			...
			if (this.itemState == TransferrableObject.ItemStates.State4 && base.photonView.IsMine)
			{
				this.InvokeRespawn();
			}
		}
		...
		private void Reparent(Transform _transform)
		{
			...
			if (this.parent)
			{
				...
				base.transform.parent.SetParent(this.parent);
			}
		}
