...
public class VRRigReliableState : MonoBehaviourPunCallbacks, IGorillaSerializeable
{
	...
	// (get) Token: 0x0600061F RID: 1567 RVA: 0x00026D28 File Offset: 0x00024F28
	// (set) Token: 0x06000620 RID: 1568 RVA: 0x00026D30 File Offset: 0x00024F30
	public bool isDirty { get; private set; } = true;

	// Token: 0x06000621 RID: 1569 RVA: 0x00026D39 File Offset: 0x00024F39
	private void Awake()
	{
		VRRig.newPlayerJoined = (Action)Delegate.Combine(VRRig.newPlayerJoined, new Action(this.SetIsDirty));
	}

	// Token: 0x06000622 RID: 1570 RVA: 0x00026D5B File Offset: 0x00024F5B
	private void OnDestroy()
	{
		VRRig.newPlayerJoined = (Action)Delegate.Remove(VRRig.newPlayerJoined, new Action(this.SetIsDirty));
	}

	// Token: 0x06000623 RID: 1571 RVA: 0x00026D7D File Offset: 0x00024F7D
	public void SetIsDirty()
	{
		this.isDirty = true;
	}

	// Token: 0x06000624 RID: 1572 RVA: 0x00026D86 File Offset: 0x00024F86
	public void SetIsNotDirty()
	{
		this.isDirty = false;
	}

	// Token: 0x06000625 RID: 1573 RVA: 0x00026D8F File Offset: 0x00024F8F
	...
	// Token: 0x06000626 RID: 1574 RVA: 0x00026DA0 File Offset: 0x00024FA0
	...
	// Token: 0x06000627 RID: 1575 RVA: 0x00026E18 File Offset: 0x00025018
	...
	// Token: 0x06000628 RID: 1576 RVA: 0x00026F5C File Offset: 0x0002515C
