...
public class TeleportTransitionWarp : TeleportTransition
{
	...
	private sealed class <DoWarp>d__3 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		bool IEnumerator.MoveNext()
		{
			...
			elapsedTime += Time.deltaTime;
			float time = elapsedTime / teleportTransitionWarp.TransitionDuration;
			float positionPercent = teleportTransitionWarp.PositionLerp.Evaluate(time);
			teleportTransitionWarp.LocomotionTeleport.DoWarp(startPosition, positionPercent);
