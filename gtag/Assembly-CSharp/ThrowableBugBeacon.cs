	...
	public static event ThrowableBugBeacon.ThrowableBugBeaconEvent OnCall
	{
		...
		add
		{
			...
			do
			{
				...
				ThrowableBugBeacon.ThrowableBugBeaconEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconEvent)Delegate.Combine(throwableBugBeaconEvent2, value);
				throwableBugBeaconEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconEvent>(ref ThrowableBugBeacon.OnCall, value2, throwableBugBeaconEvent2);
			}
		...
		remove
		{
			...
			{
				throwableBugBeaconEvent2 = throwableBugBeaconEvent;
				ThrowableBugBeacon.ThrowableBugBeaconEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconEvent)Delegate.Remove(throwableBugBeaconEvent2, value);
				throwableBugBeaconEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconEvent>(ref ThrowableBugBeacon.OnCall, value2, throwableBugBeaconEvent2);
			}
			while (throwableBugBeaconEvent != throwableBugBeaconEvent2);
		}
	...
	public static event ThrowableBugBeacon.ThrowableBugBeaconEvent OnDismiss
	{
		...
		add
		{
			...
			do
			{
				throwableBugBeaconEvent2 = throwableBugBeaconEvent;
				ThrowableBugBeacon.ThrowableBugBeaconEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconEvent)Delegate.Combine(throwableBugBeaconEvent2, value);
				throwableBugBeaconEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconEvent>(ref ThrowableBugBeacon.OnDismiss, value2, throwableBugBeaconEvent2);
			}
			while (throwableBugBeaconEvent != throwableBugBeaconEvent2);
		}
		[CompilerGenerated]
	...
	public static event ThrowableBugBeacon.ThrowableBugBeaconEvent OnLock
	{
		...
		add
		{
			...
			do
			{
				throwableBugBeaconEvent2 = throwableBugBeaconEvent;
				ThrowableBugBeacon.ThrowableBugBeaconEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconEvent)Delegate.Combine(throwableBugBeaconEvent2, value);
				throwableBugBeaconEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconEvent>(ref ThrowableBugBeacon.OnLock, value2, throwableBugBeaconEvent2);
			}
			while (throwableBugBeaconEvent != throwableBugBeaconEvent2);
		}
		[CompilerGenerated]
	...
	public static event ThrowableBugBeacon.ThrowableBugBeaconEvent OnUnlock
	{
		...
		add
		{
			...
			do
			{
				throwableBugBeaconEvent2 = throwableBugBeaconEvent;
				ThrowableBugBeacon.ThrowableBugBeaconEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconEvent)Delegate.Combine(throwableBugBeaconEvent2, value);
				throwableBugBeaconEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconEvent>(ref ThrowableBugBeacon.OnUnlock, value2, throwableBugBeaconEvent2);
			}
			while (throwableBugBeaconEvent != throwableBugBeaconEvent2);
		}
		[CompilerGenerated]
	...
	public static event ThrowableBugBeacon.ThrowableBugBeaconFloatEvent OnChangeSpeedMultiplier
	{
		...
		add
		{
			...
			do
			{
				...
				ThrowableBugBeacon.ThrowableBugBeaconFloatEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconFloatEvent)Delegate.Combine(throwableBugBeaconFloatEvent2, value);
				throwableBugBeaconFloatEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconFloatEvent>(ref ThrowableBugBeacon.OnChangeSpeedMultiplier, value2, throwableBugBeaconFloatEvent2);
			}
		...
		remove
		{
			...
			{
				throwableBugBeaconFloatEvent2 = throwableBugBeaconFloatEvent;
				ThrowableBugBeacon.ThrowableBugBeaconFloatEvent value2 = (ThrowableBugBeacon.ThrowableBugBeaconFloatEvent)Delegate.Remove(throwableBugBeaconFloatEvent2, value);
				throwableBugBeaconFloatEvent = Interlocked.CompareExchange<ThrowableBugBeacon.ThrowableBugBeaconFloatEvent>(ref ThrowableBugBeacon.OnChangeSpeedMultiplier, value2, throwableBugBeaconFloatEvent2);
			}
			while (throwableBugBeaconFloatEvent != throwableBugBeaconFloatEvent2);
		}
